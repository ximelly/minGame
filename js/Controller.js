...
export default class Controller {
  ...
  run(){
    ...
    if (Balls[0].y + Balls[0].ballw >= Balls[0].dateStore.canvas.height || ((Balls[0].x + Balls[0].ballw >= shoppingCar.x && Balls[0].x <= shoppingCar.x + shoppingCar.w) && (Balls[0].y + Balls[0].ballw >= shoppingCar.y))) {//小球触碰到地板就销毁
      Balls.shift();
    }
